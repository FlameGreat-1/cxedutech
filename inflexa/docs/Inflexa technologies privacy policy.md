...
Inflexa Technologies Limited ("Inflexa", "we", "us", or "our") respects your privacy and is committed to protecting your personal data.
...
This is collected via cookies and analytics technologies.
...
## 5. Legal Bases for Processing (GDPR Regions)

If you are located in the UK or EU, we process your data under:
...
Where required, we ensure appropriate safeguards are in place, such as:
...
| Data Type | Retention |
|-----------|-----------|
| Orders | 6–7 years (legal requirement) |
| Accounts | Until deletion requested |
...
- Do not knowingly collect data directly from children
- Do not engage in behavioural advertising targeted at children
- Do not sell children's data
- Require adult consent
...
If you believe a child's data has been improperly collected, contact us immediately.
...
If you are in California, you may contact the California Attorney General's office.
